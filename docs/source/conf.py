...
with open(os.path.join("../../", "tensortrade", "version.py")) as filehandle:
...
latex_documents = [
    (master_doc, "tensortrade.tex", "tensortrade Documentation", "Adam King", "manual"),
]
...
man_pages = [(master_doc, "tensortrade", "tensortrade Documentation", [author], 1)]
