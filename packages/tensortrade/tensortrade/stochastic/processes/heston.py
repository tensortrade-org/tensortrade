...
from tensortrade.stochastic.utils import ModelParameters, convert_to_prices, generate
...
def heston_construct_correlated_path(params: "ModelParameters", brownian_motion_one: "np.array") -> "np.array":
