...
from .agents.utils.buffers import ReplayBuffer1
from .agents.utils.common import (create_buffers, create_models, get_wandb_key,
                                  write_from_dict)
...
class TestBase:
    ...
    def test_play(
        ...
        models = create_models(agents.agents[agent_id], envs[0], agent_id)
