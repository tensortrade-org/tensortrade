...
from .agents import ACER, DDPG, DQN, TD3
from .agents.base import BaseAgent, OffPolicy, OnPolicy
from .agents.cli import Executor
from .agents.utils.buffers import ReplayBuffer1, ReplayBuffer2
from .agents.utils.cli import (agent_args, non_agent_args, play_args,
...
def executor(request):
    ...
    Returns:
        tensortrade.agents.cli.Executor
    """
...
def agent(request):
    """
    Fixture with agents available in tensortrade.agents.agents
    Args:
        request: _pytest.fixtures.SubRequest
...
def agent_id(request):
    """
    Fixture with agent ids available in tensortrade.agents.agents
    Args:
        request: _pytest.fixtures.SubRequest
...
def command(request):
    """
    Fixture with commands available in tensortrade.agents.commands
    Args:
        request: _pytest.fixtures.SubRequest
