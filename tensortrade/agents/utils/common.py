...
def register_models(agents):
    ...
    configuration folders to be added to agents.agents.
    Args:
...
def create_model(
    ...
    Args:
        env: gym environment.
        agent_id: str, one of the keys in agents.agents
...
def create_models(options, env, agent_id, **kwargs):
    ...
    Args:
        ...
        env: gym environment
        agent_id: str, one of the keys in agents.agents
        **kwargs: kwargs passed to agents.utils.common.create_model()
