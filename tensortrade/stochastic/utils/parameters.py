...
def default(base_price: float, t_gen: int, delta: float) -> ModelParameters:
    """Create a basic model parameter set with key parameters specified default parameters.
...
def random(base_price: float, t_gen: int, delta: float) -> ModelParameters:
    """Create a random model parameter set with key parameters specified default parameters.
