...
def main():
    ...
    parser = create_training_parser("TensorTrade - Advanced PBR Training")
    ...
    # Experiment tracking
    store, experiment_id, tb_logger, bridge = setup_experiment(args, "train_advanced", env_config)
    ...
    # Cleanup
    final_metrics = {"test_pnl": float(test_pnl), "test_trades": float(test_trades), "test_bh": float(test_bh)}
