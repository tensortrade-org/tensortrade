#!/usr/bin/env python3
"""
Best performing configuration based on all experiments.

Uses:
1. PBR reward (proven to learn on training data)
2. Best Optuna hyperparameters
3. Zero commission (to isolate agent skill from costs)
...
def main():
    ...
    env_config = {
        ...
        "commission": 0.003,  # 0.3% commission - train for less trading
        "initial_cash": 10000,
    }
    ...
    test_config["commission"] = 0.001  # 0.1%
    test_pnl_low = evaluate(algo, test_data, feature_cols, test_config, n=50)
